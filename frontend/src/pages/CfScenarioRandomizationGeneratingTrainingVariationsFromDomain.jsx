...
export default function CfScenarioRandomizationGeneratingTrainingVariationsFromDomain() {
  ...
  const submit = async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/cf-scenario-randomization-generating-training-variations-from-domain-rules/run`, {
        method: 'POST', headers: getHeaders(),
        body: JSON.stringify({ prompt: input, feature: 'cf-scenario-randomization-generating-training-variations-from-domain-rules', project: 'AIVRTrainingScenarioGenerator' })
      })
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <div className="mb-4">
        <h1 className="text-2xl font-bold text-slate-800">Scenario randomization generating training variations from domain rules</h1>
