...
export default function CfRealWorldIncidentSimulationGeneratedFromIncident() {
  ...
  const submit = async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/cf-real-world-incident-simulation-generated-from-incident-reports/run`, {
        method: 'POST', headers: getHeaders(),
        body: JSON.stringify({ prompt: input, feature: 'cf-real-world-incident-simulation-generated-from-incident-reports', project: 'AIVRTrainingScenarioGenerator' })
      })
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <div className="mb-4">
        <h1 className="text-2xl font-bold text-slate-800">Real-world incident simulation generated from incident reports</h1>
