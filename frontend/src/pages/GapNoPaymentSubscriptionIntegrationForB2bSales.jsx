...
export default function GapNoPaymentSubscriptionIntegrationForB2bSales() {
  ...
  const submit = async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/gap-no-payment-subscription-integration-for-b2b-sales/run`, {
        method: 'POST', headers: getHeaders(),
        body: JSON.stringify({ prompt: input, feature: 'gap-no-payment-subscription-integration-for-b2b-sales', project: 'AIVRTrainingScenarioGenerator' })
      })
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <div className="mb-4">
        <h1 className="text-2xl font-bold text-slate-800">No payment/subscription integration for B2B sales</h1>
