...
export default function CfPerformancePredictionForecastingCertificationPassFail() {
  ...
  const submit = async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/cf-performance-prediction-forecasting-certification-pass-fail/run`, {
        method: 'POST', headers: getHeaders(),
        body: JSON.stringify({ prompt: input, feature: 'cf-performance-prediction-forecasting-certification-pass-fail', project: 'AIVRTrainingScenarioGenerator' })
      })
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <div className="mb-4">
        <h1 className="text-2xl font-bold text-slate-800">Performance prediction forecasting certification pass/fail</h1>
